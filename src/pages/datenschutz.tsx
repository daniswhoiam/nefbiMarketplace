...
const Datenschutz = () => {
  return (
    <Layout>
      <main className="container mx-auto max-w-screen-xl lg:px-64 md:px-32 px-8">
        <h1>Datenschutz</h1>
        ...
        <ul className="index space-y-1">
          ...
          <li>
            <a className="index-link inline-link" href="#m3">
              Verantwortlicher
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#mOverview">
              Übersicht der Verarbeitungen
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m13">
              Maßgebliche Rechtsgrundlagen
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m27">
              Sicherheitsmaßnahmen
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m12">
              Löschung von Daten
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m225">
              Bereitstellung des Onlineangebotes und Webhosting
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m182">
              Kontakt- und Anfragenverwaltung
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m15">
              Änderung und Aktualisierung der Datenschutzerklärung
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m10">
              Rechte der betroffenen Personen
            </a>
          </li>
          <li>
            <a className="index-link inline-link" href="#m42">
